...
public class Wheel {
	...
	/*
	L'angle th�ta correspond � l'angle entre l'axe des abcisses et le vecteur du part du point
	...
	public boolean isLose(Obstacle o){
		//M�thode � appeler chaque milliseconde pour v�rifier si une des balle est en contact avec un des segments du quadrilat�re
