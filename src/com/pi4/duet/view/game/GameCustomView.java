...
public class GameCustomView extends GameView {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1326378972823136040L;

	public GameCustomView(Dimension size, Scale scale, Commands commands, GameController controller) {
