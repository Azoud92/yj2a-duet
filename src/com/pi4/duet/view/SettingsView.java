...
public class SettingsView extends JPanel{
	...
	public SettingsView(Dimension size, SettingsController controller) {
		...
		son = new JLabel("Activer/D�sactiver les effets sonores :", SwingConstants.CENTER);
		...
		son_on.setFont(new Font("Arial", Font.BOLD, 30));
		...
		son_off.setFont(new Font("Arial", Font.BOLD, 30));
		this.add(son_off);
		...
		music = new JLabel("Activer/D�sactiver la musique :", SwingConstants.CENTER);
		...
		music_on.setFont(new Font("Arial", Font.BOLD, 30));
		...
		music_off.setFont(new Font("Arial", Font.BOLD, 30));
		this.add(music_off);
		...
		inertie = new JLabel("Activer/D�sactiver l'inertie du volant :", SwingConstants.CENTER);
		...
		inertie_on.setFont(new Font("Arial", Font.BOLD, 30));
		...
		inertie_off.setFont(new Font("Arial", Font.BOLD, 30));
		...
		fond = new JLabel("Activer/D�sactiver l'arri�re plan du jeu :", SwingConstants.CENTER);
		...
		fond_on.setFont(new Font("Arial", Font.BOLD, 30));
		...
		fond_off.setFont(new Font("Arial", Font.BOLD, 30));
		this.add(fond_off);
